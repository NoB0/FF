...
namespace interpret {
	...
	public:
		...
		FuzzyFactory<T>(fuzzy::Not<T>*, fuzzy::And<T>*, fuzzy::Or<T>*, fuzzy::Then<T>*, fuzzy::Agg<T>*, fuzzy::SugenoDefuzz<T>*, fuzzy::SugenoConclusion<T>*);
		...
		virtual void changeSugeno(fuzzy::SugenoDefuzz<T>*);
		virtual void changeConclusion(fuzzy::SugenoConclusion<T>*);
	...
	template <class T>
	FuzzyFactory<T>::FuzzyFactory<T>(fuzzy::Not<T>* _not, fuzzy::And<T>* _and, fuzzy::Or<T>* _or, fuzzy::Then<T>* _then, fuzzy::Agg<T>* _agg, fuzzy::SugenoDefuzz<T>* _sugeno, fuzzy::SugenoConclusion<T>* _conclusion)
	{
		opNot = new UnaryShadowExpression<T>(_not);
		opAnd = new BinaryShadowExpression<T>(_and);
		opOr = new BinaryShadowExpression<T>(_or);

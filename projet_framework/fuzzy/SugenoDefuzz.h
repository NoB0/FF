...
namespace fuzzy {
	...
	public:
		...
		virtual T evaluate(std::vector<const interpret::Expression<T>*>*) const;
	};
	template<class T>
	T SugenoDefuzz<T>::evaluate(std::vector<const interpret::Expression<T>*>* operands) const
	{
		std::vector<const interpret::Expression<T>*>::const_iterator it;
